...
<body id = 'login_page' >
<img id='login_logo' src='<?php echo $this->skin?>img/GT-PRO-logo-new.png'> 
...
<p style="position:absolute;bottom:20px;width:100%;" align = "center" class = "copytext" >&copy; <?php echo date("Y"); ?> All Rights Reserved. </p >
